...
function idInvalidCardCompanies(invalidCards) {
    const companies = new Set();  // Use a Set to automatically avoid duplicates

    for (let card of invalidCards) {
        switch (card[0]) {  // Check the first digit of the card
            case 3:
    ...
    return Array.from(companies);  // Convert the Set to an Array before returning
}
